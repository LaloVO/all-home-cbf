            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card border border-border rounded-2xl p-6 shadow-card">
                ...
                <div className="space-y-3">
                  <h4 className="font-serif text-lg text-primary font-bold">¿No es lo que buscas?</h4>
                  <p className="font-sans text-xs text-primary/70 leading-relaxed font-light">
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 border border-accent text-accent hover:bg-accent hover:text-secondary rounded-full font-sans font-bold text-xs transition-all duration-300 shadow-sm"
                  >
