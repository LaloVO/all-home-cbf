            ...
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center shrink-0">
                <button
                  ...
                  className={`w-9 h-9 rounded-full border-2 flex items-center justify-center font-sans font-medium text-xs transition-all duration-300
                    ${isCompleted ? "bg-[#F8A018] border-[#F8A018] text-[#2E251E]" : ""}
                    ${isCurrent && !isCompleted ? "border-[#F8A018] bg-white text-[#F8A018] scale-105 shadow-md" : ""}
              ...
              {!isLast && (
                <div className="h-[2px] flex-1 bg-[#6E6259]/20 rounded min-w-[20px]">
                  <div
                    className="h-full bg-[#F8A018] transition-all duration-300 rounded"
            ...
            <div className="space-y-5 max-w-lg mx-auto">
              <div className="space-y-2">
                <Label htmlFor="nombreCompleto" className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <User className="w-4 h-4 text-[#F8A018]" />
                  Nombre Completo *
                </Label>
                <Input
                  id="nombreCompleto"
                  ...
                  className={`rounded-full bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#F8A018] focus:ring-0 ${
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <Mail className="w-4 h-4 text-[#F8A018]" />
                  Correo Electrónico *
                </Label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="telefono" className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <Phone className="w-4 h-4 text-[#F8A018]" />
                  Teléfono Móvil *
                </Label>
                <Input
                  id="telefono"
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <Home className="w-4 h-4 text-[#F8A018]" />
                    ...
                    <Label
                      ...
                      className={`flex-1 cursor-pointer border rounded-2xl p-4 flex flex-col justify-between h-20 transition-all duration-300
                        ${watch("tipoOperacion") === "compra" 
                          ? "bg-white border-[#F8A018] shadow-elegant scale-[1.02]" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#6E6259] flex items-center gap-1.5">
                    <BedDouble className="w-3.5 h-3.5 text-[#F8A018]" />
                    Habitaciones
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#6E6259] flex items-center gap-1.5">
                    <Bath className="w-3.5 h-3.5 text-[#F8A018]" />
                    Baños
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#6E6259] flex items-center gap-1.5">
                    <Car className="w-3.5 h-3.5 text-[#F8A018]" />
                    Estacionamientos
                  </Label>
                  <Select
              ...
              <div className="space-y-2">
                <Label className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <Maximize className="w-4 h-4 text-[#F8A018]" />
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-[#F8A018]" />
                  Estados de Interés *
                </Label>
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-full border border-[#6E6259]/20 bg-white/50 px-4 py-2 text-sm font-sans focus:bg-white/95 focus:border-[#F8A018]"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full bg-[#F8A018] hover:bg-[#D97706]"
                  >
                    Agregar
                  </Button>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="rounded-full bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#F8A018]"
                  />
                  <Button
                    type="button"
              ...
              <div className="space-y-3 bg-[#FAF7F2]/60 border border-[#F8A018]/25 rounded-2xl p-5 md:p-6 shadow-card">
                ...
                <Textarea
                  ...
                  className={`bg-white/70 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#F8A018] focus:ring-0 rounded-2xl ${
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-[#FAF7F2]/60 border border-[#6E6259]/10 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <Label className="font-sans text-base font-semibold text-[#2E251E] flex items-center gap-2">
                  <DollarSign className="w-5 h-5 text-[#F8A018]" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`rounded-full pl-7 bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#F8A018] focus:ring-0 ${
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#2E251E] flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-[#F8A018]" />
                  ...
                  {METODOS_PAGO.map((metodo) => (
                    ...
                    >
                      <Checkbox
                        ...
                        className="mt-0.5 border-[#F8A018]/40 data-[state=checked]:bg-[#F8A018] data-[state=checked]:border-[#F8A018]"
                      />
              ...
              <div className="bg-white/40 border border-[#6E6259]/10 rounded-2xl p-5 shadow-card space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    className="data-[state=checked]:bg-[#F8A018]"
                  />
                </div>
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
                        ...
                        <Label
                          ...
                          className={`flex-1 cursor-pointer border rounded-2xl p-4 flex gap-4 items-center transition-all duration-300 shadow-card
                            ${watch("usoDestino") === opc.id
                              ? "bg-white border-[#F8A018] scale-[1.01]"
                              : "bg-white/40 border-[#6E6259]/10 hover:bg-white/60"
                            }
                          `}
                        >
                          <div className="bg-[#FAF7F2] p-2.5 rounded-xl border border-[#6E6259]/10 text-[#F8A018]">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#F8A018] focus:ring-0 rounded-2xl"
                />
              </div>
            </div>
          </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 border border-[#6E6259]/15 shadow-card hover:border-[#F8A018]/30 transition-all duration-300 space-y-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 space-y-1">
                    <h3 className="font-sans text-base font-semibold text-[#2E251E] flex items-center gap-2">
                      <Calendar className="w-5 h-5 text-[#F8A018]" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full h-10 rounded-full border border-[#6E6259]/20 bg-white px-4 text-sm font-sans focus:border-[#F8A018] focus:outline-none"
                        />
                      </div>
                        ...
                        {citaVirtualFecha ? (
                          isLoadingBusySlots ? (
                            <div className="h-10 flex items-center justify-center text-xs text-[#6E6259]/60">
                              <Loader2 className="w-4 h-4 mr-2 animate-spin text-[#F8A018]" />
                                  ...
                                  <button
                                    ...
                                    className={`h-9 rounded-full text-xs font-sans font-medium border transition-all duration-300
                                      ${isBusy 
                                        ...
                                        : isSelected
                                          ? "bg-[#F8A018] border-[#F8A018] text-white shadow-md"
                                          : "bg-white border-[#6E6259]/20 text-[#6E6259] hover:border-[#F8A018] hover:bg-[#FAF7F2]"
                                      }
                                    `}
                                  >
                                    {hour}
              ...
              <div className="bg-[#FAF7F2]/60 border border-[#6E6259]/10 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <h3 className="font-sans text-base font-semibold text-[#2E251E] flex items-center gap-2">
                  <FileText className="w-5 h-5 text-[#F8A018]" />
                ...
                <div className="space-y-3">
                  {TIPOS_DOCUMENTOS.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="bg-white rounded-2xl p-4 border border-[#6E6259]/15 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-card hover:border-[#F8A018]/30 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          {uploadingDocs[doc.id] ? (
                            <Loader2 className="w-5 h-5 text-[#F8A018] animate-spin shrink-0" />
                          ) : isUploaded ? (
                          ...
                          <div>
                            ...
                            {uploadingDocs[doc.id] ? (
                              <span className="text-[10px] text-[#F8A018] font-sans font-medium animate-pulse">Subiendo a base de datos...</span>
                            ) : isUploaded ? (
                        ...
                        <div className="shrink-0 flex items-center gap-3">
                          <Button
                            ...
                            className={`rounded-full font-sans text-xs border-[#6E6259]/20 hover:bg-[#FAF7F2] hover:text-[#F8A018] ${
              ...
              {/* Nota de Alerta */}
              <div className="bg-[#FAF7F2] border border-[#F8A018]/20 rounded-2xl p-5 flex gap-3 shadow-card">
                <AlertCircle className="w-5 h-5 text-[#F8A018] shrink-0 mt-0.5" />
      ...
      <div className="flex justify-between items-center mt-8 gap-4 px-2">
        ...
        {currentStep < STEPS.length ? (
          <Button
            ...
            className="rounded-full px-8 bg-[#F8A018] hover:bg-[#D97706] font-sans text-sm text-[#2E251E] font-bold shadow-md hover:scale-105 transition-all duration-300"
          >
            Siguiente
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="rounded-full px-8 bg-[#F8A018] hover:bg-[#D97706] font-sans text-sm text-[#2E251E] font-bold shadow-md hover:scale-[1.03] transition-all duration-300"
          >
            {isSubmitting ? (
              <>
                <Loader2 className="w-4 h-4 mr-2 animate-spin text-[#2E251E]" />
                Enviando Expediente...
              </>
            ) : (
              <>
